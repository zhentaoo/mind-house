...
- [Puppeteer官方文档 ](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md#puppeteerlaunchoptions)

### 项目Repo
[直接访问：https://github.com/zhentaoo/puppeteer-deep ](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md#puppeteerlaunchoptions)


### 几个有可用的Demo
- UI自动化（使用Puppeteer可以模拟用户操作，模拟表单填写）
- 前端监控（https://github.com/zhentaoo/hawk-eye）
